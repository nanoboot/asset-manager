...
<html>
    <head>
        <title>Upload Asset screenshot - Asset Manager</title>
...
<% if(number != null) {%>
    <span class="nav"><a href="index.jsp">Home</a>
        ...
        <a href="upload_asset_image.jsp?number=<%=number%>" class="nav_a_current">Upload image</a>
    </span>
<% } %>
...
<%
        String param_asset_screenshot = request.getParameter("asset_image");

//param_asset_screenshot != null && !param_asset_screenshot.isEmpty();
    %>

    <% if (!formToBeProcessed) {%>
    <form action="upload_asset_image.jsp"  method = "post" enctype = "multipart/form-data">
        Select a file to upload: <br />

        <input type = "file" name = "asset_image" size = "50" />
        <br /><br />
    ...
    <%
        ...
        String filePath = System.getProperty("asset-manager.confpath") + "/" + "assetsImages/";
            ...
            try {
                ...
                while (i.hasNext()) {
                    ...
                    if (!fi.isFormField()) {
                        ...
                        out.println("<span class=\"margin_left_and_big_font\">Uploaded image.</span><br>");
                    }
                    if (fi.isFormField()) {
    ...
    out.println("<a href=\"read_asset.jsp?number="+ number +"\">Back to asset</a>");
    %>
